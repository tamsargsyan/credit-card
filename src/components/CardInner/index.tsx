...
const CardInner: React.FC<CardInnerProps> = ({
  ...
  const focusInput = (_: React.FocusEvent<HTMLInputElement, Element> | React.FocusEvent<HTMLSelectElement, Element>, targetRef: React.RefObject<HTMLLabelElement>) => {
    ...
    <div className="card-form__inner">
          <div className="card-input">
            ...
            <input
              ...
              value={cardNumber}
              onChange={(e) =>  {
                e.target.value.length <= generateCardNumberMask() && setCardNumber(e.target.value)
              }}
          ...
          <div className="card-input">
            ...
            <input
              ...
              className="card-input__input"
              value={cardName}
              onChange={(e) =>  (/^[A-Za-z]+$/.test(e.target.value) || e.target.value === "") && setCardName(e.target.value)}
              ...
              <div className="card-form__group">
                ...
                >
                  ...
                  {Array.from({ length: 12 }).map((_, index) => (
                    <option
                      key={index}
                      defaultValue={minCardYear + index}
                    >
                      {minCardYear + index}
                    </option>
                  ))}
